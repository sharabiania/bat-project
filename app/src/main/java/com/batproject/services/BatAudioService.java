...
import com.batproject.classes.ASCallback;
import com.batproject.classes.ASCountDownTimer;
import com.batproject.interfaces.IASEventListener;
import com.batproject.services.*;

public class BatAudioService {
    ...
    private BatLogService log;
    private ASCountDownTimer timer;
    private File mFile;
    //endregion

    //region Constructors
    public BatAudioService(Context context) {
        c = context;
        log = new BatLogService(LOG_TAG);
